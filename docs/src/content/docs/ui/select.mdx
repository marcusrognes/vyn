...
work is offloaded to [`@vyn/ui/keyboard-nav`](/vyn/ui/keyboard-nav/),
which you import alongside.

## See also

- [`@vyn/ui/keyboard-nav`](/vyn/ui/keyboard-nav/) — arrow keys and focus management; usually paired
- [`@vyn/ui/drag-drop`](/vyn/ui/drag-drop/) — reads this behavior's selection state to drag multiple items at once
